...
public class VentaDao {
    ...
    public void pdfV(int idventa, int Cliente, double total, String usuario) {
        try {
            ...
            doc.open();
            Image img = Image.getInstance(getClass().getResource("/Img/iMLogo100x100.png"));
            //Fecha
            Paragraph fecha = new Paragraph();
            Font negrita = new Font(Font.FontFamily.UNDEFINED, 12, Font.BOLD, BaseColor.BLUE);
            ...
            firma.add("------------------------------------\n");
            //Image s_C = Image.getInstance(getClass().getResource("/Img/sello_Cancelado.png"));
            //firma.add(s_C);
            firma.add("Firma \n");
